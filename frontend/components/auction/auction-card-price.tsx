      ...
      return (
        <div className={cn(
          ...
          <div className="flex items-center gap-2">
            ...
            <span>{formatTokenAmount(currentPrice, 18, 4)} {paymentToken.symbol}</span>
          </div>
      ...
      return (
        <div className="text-2xl font-bold text-green-600 dark:text-green-400">
          <div className="flex items-center gap-2">
            ...
            <span>{formatTokenAmount(auction.clearingPrice || '0', 18, 4)} {paymentToken.symbol}</span>
          </div>
          <CardDescription className="text-xs mt-1">
      ...
      return (
        <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
          <div className="flex items-center gap-2">
            ...
            <span>{formatTokenAmount(auction.startPrice, 18, 4)} {paymentToken.symbol}</span>
          </div>
          <CardDescription className="text-xs mt-1">
            Starting Price
          </CardDescription>
