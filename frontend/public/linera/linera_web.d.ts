...
export interface InitOutput {
  ...
  readonly closure748_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
  readonly __externref_table_dealloc: (a: number) => void;
  readonly closure2719_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hae10f63ee40fb444_multivalue_shim: (a: number, b: number) => [number, number];
  readonly closure2874_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3376_externref_shim: (a: number, b: number, c: any, d: any) => void;
